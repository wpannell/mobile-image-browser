...
public class ANewlyCreatedWrappingGwtQueryButtonShould extends GWTTestCase {
  private static final String SELECTOR = "a.to_nav";
  private static final int TIMEOUT = 500;
  private GwtQueryWrappingButton button;

  @Override
  protected void gwtSetUp() {
    RootPanel.get().add(new FakeUi());
    button = new GwtQueryWrappingButton(SELECTOR);
    button.wrap();
  }
